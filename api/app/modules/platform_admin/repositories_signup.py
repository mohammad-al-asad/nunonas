...
class AdminSignupVerificationRepository:
    def __init__(self, db: Database):
        self.code_collection: Collection = db["platform_admin_signup_codes"]
        self.token_collection: Collection = db["platform_admin_signup_tokens"]
