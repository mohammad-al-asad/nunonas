...
const FALLBACK_IMAGE = require("../../../../../assets/images/spa/galley/Rectangle 2.png");

const SpaImageHeader = ({ image, images = [], entityId }) => {
  ...
  return (
    <View style={styles.container}>
      <FlatList
        ...
        keyExtractor={(_, index) => `spa-header-image-${index}`}
